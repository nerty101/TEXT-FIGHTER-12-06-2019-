...
printf("     Player HP: %d\n\n", playerhp);
printf("     CPU HP: %d\n\n", enemyhp);
//if ((new1 > 0) || (new2 > 0) || (new3 > 0) || (new6 > 0)|| (cpusp3 > 0) || (bonrec2 > 0) || (magrec2 > 0) || (new6 > 0) || (wnctrec > 0) || (wnctrec7 > 0))
//printf("\n");
if (cpusp3 > 1)
{
if (new1 < 1)
...
if ((wnctrec7 < 1) && (wnctrec < 1)) //|| ( torwnrt > 0) || (wnrt > 0))
printf("\n");
if (ctr2 > 0)
{
...
//if (new5 < 1)
//{
//printf("\n");///put in space take out?
//}
if (new5 > 0)
{
printf("     NEW RECORD!\n");//put in space start take out?
new5 = 0;
}
Sleep (300);
if (posdef > 0)
