...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, new11 = 0, hypsp3 = 0;
...
///TEST LINES***BRACES?***if (((magrec2 < 1) && (bonrec2 < 1) && (cpusp3 > 0)) || ((magrec2 > 0) && (bonrec2 < 1) && (cpusp3 < 1)) || ((magrec2 < 1) && (bonrec2 > 0) && (cpusp3 < 1)))
///****printf("\n");
...
if (cpuwn2 > 0)
{
if (((cpuwn2 > 0) && (torwnrt == wnrt) && (wnrtrec > wnrtrec3)) || ((cpuwn2 > 0) && (torwnrt > wnrt) && (wnrtrec > wnrtrec3) && (wnrt > wnrtrec3)) || ((cpuwn2 > 0) && (torwnrt > wnrt) && (wnrtrec > wnrtrec3) && (wnrt < wnrtrec3)))
printf("  ");
...
{
{
dice1 = (rand() % 700 + cpusp + diflev) + 1;//was 7 now 70
...
printf("     You defeated the CPU!");///took one space here
if (((new6 > 0) && (bonchn > 2) && (new2 > 0) && (cpulow < 1)) || ((new6 > 0) && (magchn > 2) && (new3 > 0) && (cpulow < 1)) || ((new6 > 0) && (bonchn > 2) && (new2 < 1) && (cpulow < 1)) || ((new6 > 0) && (magchn > 2) && (new3 < 1) && (cpulow < 1))) ///need new2 or new3???
printf("\n");
if (((new6 < 1) && (bonchn > 2) && (new2 > 0) && (cpulow < 1)) || ((new6 < 1) && (magchn > 2) && (new3 > 0) && (cpulow < 1)) || ((new6 < 1) && (bonchn > 2) && (new2 < 1) && (cpulow < 1)) || ((new6 < 1) && (magchn > 2) && (new3 < 1) && (cpulow < 1))) ///need new2 or new3???
printf("\n");
if (((posbon > 0) && (bonchn < 3)) || ((posmag > 0) && (magchn < 3)) || (cpulow > 0)) //TOOK THIS OUT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!06072019
printf("\n");
if ((((new6 < 1) && (bonchn > 2) && (new2 > 0)) || ((new6 < 1) && (magchn > 2) && (new3 > 0))) || ((((new6 < 1) && (bonchn > 2) && (new2 < 1)) || ((new6 < 1) && (magchn > 2) && (new3 < 1)) || (((posbon > 0) || (posmag > 0)) && (new6 < 1)))))/// add new3! and magchn!!! || (new3 < 1)))/// && (cpulow < 1))// && (bonchn < 3)) || ((new6 > 0) && (posmag > 0) && (magchn < 3))) //  ((magchn < 3) || bonchn < 3))) /// chn|| (new6 < 1) && (posbon < 0))
printf("\n");
if (new6 > 0)
...
printf("     Unbelievable!\n");
if (((ctr < 7) &&  (cpusp > 1) && (new6 > 0)) ||  ((ctr > 6) &&  (cpusp > 1) && (new6 > 0)) || ((ctr < 7) &&  (cpusp < 2) && (new6 > 0)))
...
if (((ctr < 7) &&  (cpusp > 1) && (new6 > 0)) || ((ctr > 6) && (cpusp > 1) && (new6 > 0))) //|| ((ctr > 6) && (cpusp < 2) && (new6 < 1)))///       //|| ((ctr > 6) && (cpusp < 2) && (new6 > 0)))
printf("\n");
printf("     How did you do that?\n");
if (((cpusp < 2) && (ctr < 7) && (new6 < 1)) || ((ctr > 6) && (cpusp < 2) && (new6 < 1)) || ((new6 < 1) && (cpusp > 1) && (ctr > 6)) || ((ctr > 6) &&  (cpusp < 2) && (new6 > 0)) || ((ctr < 7) &&  (cpusp < 2) && (new6 > 0)))
printf("\n");
if (((ctr > 6) && (cpusp > 1) && (new6 > 0)) || ((ctr > 6) && (cpusp < 2) && (new6 < 1)) || ((ctr > 6) &&  (cpusp < 2) && (new6 > 0)) || ((ctr < 7) &&  (cpusp < 2) && (new6 > 0)))
...
if (((new6 < 1)  && (cpusp  > 1) && (ctr < 6)) || ((new6 > 0) && (cpusp < 2) && (ctr < 6)) ||  ((new6 < 1)  && (cpusp < 2) && (ctr < 6)))
printf("\n");
if (((new6 > 0) && (cpusp < 2) && (ctr < 6)) || ((new6 > 0) && (cpusp > 1) && (ctr > 5)))
printf("     And a phenomenal finish!\n");
if (((new6 < 1) && (cpusp > 1) && (ctr < 6)) ||  ((new6 < 1)  && (cpusp < 2) && (ctr < 6)))
...
printf("     It was a fabulous contest!\n\n");
...
{
{
dice5 = (rand() % 29 + (diflev + cpusp));// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28 29 -1
...
if  ((diceE > 20) && (diceB >= 4) && (diceB <= 6) && (playerhp > 0)) //diceE was > 18 then 17, 50 32  = 18 SO 25 16 = 9 25 - 4 21 SO 22
...
if (playerhp < 1)// || (cpspcncl > 0) || (cpspcncl3 > 0))
{
diceF = 15;
}//added
else
...
if  ((diceF > 30) && (diceB >= 5) && (diceB <= 6) && (playerhp > 0))
{
playerhp = (playerhp - 6);
...
if (playerhp < 1) // || (cpspcncl > 0) || (cpspcncl2 > 0) || (cpspcncl3 > 0))
{
diceC = 15;
}
else
...
if ((enspcomb3 == 1) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceF > 30) && (diceB >= 5) && (diceB <= 6)) && ((diceC > 48) && (diceB == 5)))
{
...
if (enemspcombC != 1)
{
if ((enspcomb1 == 1) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceF > 30) && (diceB >= 5) && (diceB <= 6)))
{
printf("\n     THE CPU SUPER SPECIAL COMBO!\n");
printf("     THAT'S A FANTASTIC CPU COMBO!\n");
enspcomb6 = 1;
if (playerhp < 1)
{
...
if ((enspcomb2 == 1) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6)) && ((diceC > 48) && (diceB == 5)))
{
printf("\n     THE CPU HYPER SPECIAL COMBO!\n");
printf("     THAT'S A POWERFUL CPU COMBO!\n");
if (playerhp < 1)
{
printf("     AND A SUPERB COMBO FINISH!\n\n");
}
spatt = 0;
hypsp = 0;
enspcomb2 = 0;
...
if ((enspcomb2 == 1) && ((diceC > 48) && (diceB == 5)) && ((diceF > 30) && (diceB >= 5) && (diceB <= 6)))
{
printf("\n     THE CPU HYPER SUPER SPECIAL COMBO!\n");
printf("     THAT WAS AN AWESOME CPU COMBO!\n");
if (playerhp < 1)
{
printf("     PHENOMENAL FINISHING MOVES!\n\n");
}
supspatt = 0;
hypsp = 0;
enspcomb2 = 0;
...
printf("     A FORMIDABLE CPU MAGIC SPECIAL COMBO!\n");
emgspcom = 0;
emagsup = 1;
if (playerhp < 1)
{
printf("     AND AN AWESOME CPU MAGIC SPECIAL WIN!\n\n");
}
}
if ((emgspcom5 == 1) && (emgspcom != 1) && ((diceE > 20) && (diceB >= 4) && (diceB <= 6) && (diceM > 40)))
{
printf("\n     THE CPU SUPER MAGIC SPECIAL COMBO!\n");
printf("     AN AMAZING CPU MAGIC SPECIAL COMBO!\n");
emgspcom5 = 0;
if (playerhp < 1)
{
printf("     AND A GREAT CPU MAGIC SPECIAL FINISH!\n\n");
}
}
if (playerhp < 1)
{
...
printf("     THAT'S AN INCREDIBLE CPU MAGIC COMBO!\n");
emgspcom4 = 0;
mspatt = 0;
mspatt2 = 0;
mspatt3 = 0;
...
if (playerhp < 1)
{
printf("     AND A MAGNIFICENT MAGIC COMBO FINISH!\n\n");
}
}
...
diceG = (rand() % 11) + 1; //11
diceG = (rand() % 10) + 1; //10
if ((diceG > 5) && (consectr < 3))// diceG was 6 consectr < 3
++consectr;
}
if (enemyhp < 1)
{
...
if ((consectr > 0) && (diceB > 6) && (playerhp > 0))// > 2!
{
enemyhp = (enemyhp - 1);
