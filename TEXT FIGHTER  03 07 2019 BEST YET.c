...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, cpspcncl = 0, cpuwnrt2 = 0, bonrec3 = 0, magrec3 = 0;
...
if (((new6 > 0) && (bonchn > 2) && (new2 > 0)) || ((new6 > 0) && (magchn > 2) && (new3 > 0)))
printf("\n");
