...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, new9 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, cpspcncl = 0;
...
if ((new2 > 0) && (new6 > 0))// || ((new2 > 0) && (new6 > 0)))
printf("\n");
if (new2 > 0)
...
if ((new3 > 0) && (new6 > 0))// || ((new2 > 0) && (new6 > 0)))
printf("\n");
if (new3 > 0)
...
{
{
dice5 = (rand() % 28 + (diflev + cpusp));// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28 -1
...
if (new6 > 0)
printf("     You've been undefeated in the past %d fights!\n\n", wnctrec7);
if (cpusp > 1)
...
printf("\n");
if (new6 > 0)
printf("     You've been undefeated in the past %d matches!\n", wnctrec7);
if (cpusp > 1)
printf("     You performed Special Attacks in %d consecutive rounds!\n", cpusp);
if ((ctr > 7) && (cpusp > 1) && (new6 > 0))
...
{
diceM = (rand() % 94) + (1 + diflev);
diceN = (rand() % 96) + (1 + diflev);
