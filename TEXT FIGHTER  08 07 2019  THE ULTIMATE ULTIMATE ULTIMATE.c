...
if (((posdef > 0) && (wnctrec > 1)) || (wnctrecA > 0))
{
...
if ((posdef > 0) && (wnctrec7 < 3) && (wnctrecA > 0))
printf("\n");
if (ctr2 > 0)
{
...
if ((posdef > 0) && ((wnrtrec3 > 0) || (wnrtrec > 0) || ( torwnrt > 0) || (wnrt > 0)))
printf("\n");
...
if (wnct7 > wnctrec7)
{
wnctrec7 = wnct7;///wnctrec not wnctrec7, was!!!!
if (wnctrecA > 0)///*************************
++new6;
}
if (wnct2 > wnctrec)
