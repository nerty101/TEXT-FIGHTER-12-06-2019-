...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, cpspcncl = 0, cpuwnrt2 = 0;
...
if (emagsup > 0)
diceN = (rand() % 64) + (1 + diflev);
if ((diceM > 68) && (diceN > 44))
