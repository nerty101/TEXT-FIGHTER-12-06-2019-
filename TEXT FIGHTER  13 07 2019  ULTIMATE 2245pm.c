...
printf("     AN INCREDIBLE CPU COMBO!\n");
enspcomb6 = 1;
if (playerhp < 1)
{
...
printf("     THAT'S A GREAT MAGIC SPECIAL COMBO!\n");
emgspcom = 0;
emagsup = 1;
emagsup6 = 0;
if (playerhp < 1)
{
printf("     AND A FORMIDABLE CPU FINISHER!\n\n");
}
}
...
if (playerhp < 1)
{
printf("     AND AN EXCELLENT CPU WIN!\n\n");
}
}
if (playerhp < 1)
{
...
if (playerhp < 1)
{
printf("     AND AN INCREDIBLE MAGIC FINISH!\n\n");
}
}
...
printf("     A new Consecutive Match Win Record!\n");
if (ctr < 5)
printf("     You brought the match to an early finish!\n");
if (((consectr < 2) && (((cpusp > 1) && (ctr < 5) && (new6 > 0)) || ((cpusp > 1) && (ctr < 5) && (new6 < 1)) ||  ((cpusp > 1) && (ctr > 4) && (new6 > 0)) || ((cpusp < 2) && (ctr < 5) && (new6 > 0)))))
printf("\n");
if (cpusp > 1)
...
if (new6 > 0)
printf("     A new Consecutive Match Win Record!\n");
if (((cpusp < 2) && (ctr < 5)) || ((cpusp > 1) && (ctr > 4)))
printf("\n");
if (ctr < 4)
...
if (((new6 > 0) && (cpusp < 2)  && (ctr > 4)) || ((ctr < 5) && (new6 > 0) && (cpusp < 2)))
printf("\n     Good counter-fighting technique!\n\n");
if (((new6 < 1) && (cpusp < 2) && (ctr < 5)) || ((ctr > 4) && (new6 < 1) && (cpusp  < 2)))
printf("\n     That was a good defence!\n\n");
if (((new6 > 0) && (cpusp > 1) && (ctr > 4)) || ((ctr < 5) && (new6 > 0) && (cpusp  > 1)))
printf("\n     Excellent counter-fighting!\n\n");
break;
}
