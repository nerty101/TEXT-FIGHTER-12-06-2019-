...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, cpspcncl = 0, cpspcncl2 = 0, cpspcncl3 = 0;
float wnrt = 0, wnrtrec = 0, torwnrt = 0, torwnrt2 = 0, torwnrt3 = 0, wnrt2 = 0, wnrtrec2 = 0, wnrtrec3 = 0, wnrtrec4 = 0, wnrtrec5 = 0, wnrt3 = 0, wnrt6 = 0, wnrt5 = 0, wnrt4 = 0, hypsp3 = 0, cpuwnrt = 0, cpuwnrt2 = 0;
time_t t;
...
if (ctr < 5)
printf("     An early finish to the contest!\n");
if (new6 > 0)
...
{
diceM = (rand() % 90 + diflev) + 1;
if (diceM > 74)
{
diceR = (rand() % 100 + diflev) + 1;
if (diceR > 70)
++cpspcncl2;
diceS = (rand() % 100 + diflev) + 1;
