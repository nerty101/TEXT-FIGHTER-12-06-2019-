...
if (((posdef > 0) && (wnctrec7 < 3) && (wnctrecA > 0)) || ((posdef > 0) && (wnctrec7 < 3) && (wnctrecA < 1)))
printf("\n");
if (ctr2 > 0)
{
...
printf("\n");
if (((posbon > 0) && (bonchn < 3)) || ((posmag > 0) && (magchn < 3))) ///|| (cpulow > 0)) //TOOK THIS OUT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!08072019
printf("\n");
if ((((new6 < 1) && (bonchn > 2) && (new2 > 0)) || ((new6 < 1) && (magchn > 2) && (new3 > 0))) || ((((new6 < 1) && (bonchn > 2) && (new2 < 1)) || ((new6 < 1) && (magchn > 2) && (new3 < 1)) || ((posbon > 0) || (posmag > 0)) && (new6 < 1)) || (cpulow > 0)))/// add new3! and magchn!!! || (new3 < 1)))/// && (cpulow < 1))// && (bonchn < 3)) || ((new6 > 0) && (posmag > 0) && (magchn < 3))) //  ((magchn < 3) || bonchn < 3))) /// chn|| (new6 < 1) && (posbon < 0))
printf("\n");
if (new6 > 0)
...
{
diceM = ((rand() % 70 + 1) + (diflev + 2));//78 60
...
{
diceN = ((rand() % 116 + 1) + (diflev + 2));//174, 164 130
}
...
{     ///PUT ALL 3 BACK
diceP = ((rand() % 108 + 1) + (diflev + 2));//180, 170 136
}    ///PUT ALL 3 BACK
