...
printf("\n");
if ((posdef < 1) && ((magrec2  > 2) || (bonrec2 > 2) || (cpusp3 > 1)))// || (wnrt > 0)))
printf("\n");
if (ctr2 > 0)
{
...
if (playerhp < 1)
{
printf("     AND A MAGNIFICENT COMBO FINISH!\n\n");
}
spatt = 0;
supspatt = 0;
enspcomb1 = 1;
...
if (playerhp < 1)
{
printf("     AND A FANTASTIC COMBO FINISH!\n\n");
}
spatt = 0;
hypsp = 0;
enspcomb2 = 0;
...
printf("     A PHENOMENAL CPU COMBO!\n");
if (playerhp < 1)
{
printf("     AWESOME FINISHING MOVES!\n\n");
}
supspatt = 0;
hypsp = 0;
enspcomb2 = 0;
...
if (playerhp < 1)
{
printf("     AND AN UNBEATABLE MAGIC COMBO FINISH!\n\n");
}
}
...
if (new6 < 1)
printf("     That's a sharp move!\n");
if (((consectr < 3) && (((cpusp > 1) && (ctr < 4) && (new6 > 0)) || ((cpusp > 1) && (ctr < 4) && (new6 < 1)) ||  ((cpusp > 1) && (ctr > 3) && (new6 > 0)) || ((cpusp < 2) && (ctr < 4) && (new6 > 0)))))
printf("\n");
if (cpusp > 1)
...
if ((consectr > 2) && (diceB > 6) && (playerhp > 0))// > 2!
{
enemyhp = (enemyhp - 1);
