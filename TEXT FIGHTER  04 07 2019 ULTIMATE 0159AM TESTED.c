...
main()
{
int dice1, dice2, dice3, dice4, dice5, dice6, diceB, diceC, diceE, diceF, diceG, diceL, diceM, diceN, diceP = 0, diceQ = 0, diceR = 0, diceS = 0;
...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, cpspcncl = 0, cpspcncl2 = 0, cpspcncl3 = 0, new11 = 0, hypsp3 = 0;
...
if (((new6 > 0) && (bonchn > 2) && (new2 > 0)) || ((new6 > 0) && (magchn > 2) && (new3 > 0)))///need new2 or new3???
printf("\n");
if (((posbon > 0) && (bonchn < 3)) || ((posmag > 0) && (magchn < 3)) || (cpulow > 0))//added these two lines
printf("\n");
...
printf("\n     That was superb magic technique!\n\n");
...
printf("     A master class in magic technique!\n");
...
if (((ctr > 7) && (cpusp > 1) && (new6 > 0)) || ((ctr < 8) && (cpusp < 2) && (new6 > 0)) || ((cpusp < 2) && (ctr < 8) && (new6 < 1)))
printf("\n");
break;
}
...
if ((diceB >= 4) && (diceB <= 6) && (playerhp > 0))
{
diceM = (rand() % 90 + diflev) + 1;//90
if (diceM > 74)
{
diceR = (rand() % 100 + 1);
if (diceR > 70)
++cpspcncl2;
diceS = (rand() % 100 + 1);
if ((diceS > 70) && (diceR < 71))
++cpspcncl3;
}
if (emagsup > 0)
diceN = (rand() % 100 + diflev) + 1;//diceN 100
if ((diceM > 68) && (diceN > 80))//diceM > 44 68 diceN > 44
diceQ = (rand() % 100 + 1);
if (diceQ > 50)
++cpspcncl;
}
...
if (playerhp < 1)
{
printf("     AND A GREAT CPU MAGIC SPECIAL WIN!\n\n");
}
}//supspatt = 0;
if (playerhp < 1)
{
...
if ((emagsup > 0) && ((diceN > 80) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && ((spatt2 < 1) && (supspatt2 < 1)))
{//&& (enemyhp < 5)) DICE E ORIGINALLY 16
...
{     ///PUT ALL 3 BACK
diceP = (rand() % 100 + diflev) + 1;//100
}    ///PUT ALL 3 BACK
if ((emagsup5 > 0) && ((diceP > 76) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 80) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 68) && (diceB >= 4) && (diceB <= 6)) && (playerhp > 0) && ((spatt2 < 1) && (supspatt2 < 1) && (hypsp2 < 1)))// diceN at 80 vs 200 quite rare
{//
...
if ((emgspcom4 == 1) && ((diceN > 80) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 68) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0)))////////////////&& (playerhp > 0)) //&& (diceB >= ) && (diceB <= 6)))
{
...
if ((emgspcom3 == 1) && ((diceP > 76) && (diceB >= 4) && (diceB <= 6)) && ((diceN > 80) && (diceB >= 4) && (diceB <= 6)) && ((diceM > 68) && (diceB >= 4) && (diceB <= 6)) && ((mspatt3 > 0) && (mspatt4 > 0) && (mspatt5 > 0))) //&& (playerhp > 0)) //&& (diceB >= ) && (diceB <= 6)))
{
