...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, new11 = 0, hypsp3 = 0, wnctrecA = 0;
...
if ((wnctrec7 > 2) && (wnctrec > 1) &&  (wnctrecA > 0))
{
printf("\n     Consecutive Match Win Record: %d\n\n", wnctrec7);
}
if ((posdef > 0) && (wnctrec > 1) && (wnctrec7 < 3) &&  (wnctrecA < 1))
printf("\n");
if ((posdef > 0) && (wnctrec> 1))
++wnctrecA;
if (ctr2 > 0)
